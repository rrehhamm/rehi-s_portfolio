...
// Use `null` or empty string for links that don't exist yet — components must
// render an editable "coming soon" placeholder rather than a fake URL.
...
export const projects = [
  {
    ...
    technologies: [
      "React", "Vite", "JavaScript", "FastAPI", "Python", "SQLAlchemy",
      "PostgreSQL", "Neon", "Gemini API", "JWT", "REST API", "Postman",
      "Swagger", "Figma", "GitHub",
    ],
    responsibilities: [
    ...
    links: { github: null, liveDemo: null, caseStudy: cvisionDocumentation },
    screenshots: [],
  ...
  },
  {
    ...
    overview:
      "Waves is a full-stack e-commerce platform that allows users to browse products, explore categories and brands, manage carts and wishlists, complete orders, and interact with a dynamic administrative system.",
    features: [
      "User authentication", "Product browsing", "Categories", "Brands",
      "Product search", "Product details", "Shopping cart", "Wishlist",
      "Checkout", "Order placement", "Order history", "Order details",
      "User profile", "Arabic and English interface support",
      "Admin dashboard", "Dynamic customer statistics", "Product management",
      "Category management", "Brand management", "Banner management",
      "Featured category management", "Featured brand management",
      "Discount management", "Order management", "Dynamic home-page content",
      "Archive and data-management workflows",
    ],
    technologies: [
      "Laravel", "PHP", "MySQL", "React", "JavaScript", "REST API",
      "Postman", "Git", "GitHub", "XAMPP", "Figma",
    ],
    responsibilities: [
      "Worked on backend development",
    ...
    links: { github: null, liveDemo: null, caseStudy: null },
    screenshots: [],
  },
  {
    id: "utado",
    ...
    technologies: [
      "Next.js", "TypeScript", "Tailwind CSS", "Node.js", "Express",
      "PostgreSQL", "Redis", "Zod", "Docker", "JWT", "Vitest", "Playwright", "GitHub Actions",
    ],
    responsibilities: [
